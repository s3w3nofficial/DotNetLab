...
public sealed class TemplateCacheGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(snapshots.Combine(context.CompilationProvider), static (ctx, t) =>
        {
            var (snapshot, compilation) = t;
            var ns = compilation.AssemblyName == "DotNetLab.AppNew"
                ? "DotNetLab.Infrastructure.Persistence"
                : "DotNetLab.Lab";
